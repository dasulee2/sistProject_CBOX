...
<body>
	...
	<div class="luncher" style="padding-right: 20px;">
		<ul>
			...
			<li style="padding-right:10px;">
				<a class="login" href="../shop/login.jsp" style="color:white;"><span class="glyphicon glyphicon-off"></span>로그인</a>
			</li>
		</ul>
	</div>
	<br>
	<div style="margin:auto; width:80%; text-align: center; background:#EAEAEA; border-radius:10px; margin-bottom: 100px; padding-bottom: 50px;">
		<div class="container">
	        ...
	        <form action="reviewReg.do" method="post">
			<table class="table" style="background-color: #FEFCF0;">
			    ...
			    <tbody>
						...
						<tr>
							<th>평점:</th>
			                <td>
			                <select id="selectBox" name="GPA" class="form-control pull-left" style="width: 200px;"> 
				                <option class="s_gpa" value="1">1</option> 
				                <option class="s_gpa" value="2">2</option> 
				                <option class="s_gpa" value="3">3</option> 
				                <option class="s_gpa" value="4">4</option> 
				                <option class="s_gpa" value="5">5</option> 
				                <option class="s_gpa" value="6">6</option> 
				                <option class="s_gpa" value="7">7</option> 
				                <option class="s_gpa" value="8">8</option> 
				                <option class="s_gpa" value="9">9</option> 
				                <option class="s_gpa" value="10">10</option> 
			                </select>
					             &nbsp;&nbsp;&nbsp;&nbsp;<img id="star">
							</td>
			            </tr>
			            <tr>
			                <th>내용: </th>
			                <td><textarea cols="10" placeholder="내용을 입력하세요. " id="content" name="content" class="form-control" style="height:200px;"></textarea></td>
			            </tr>
			            <tr>
			                <td colspan="2">
			                    <a class="btn btn-default pull-right"  href='movieDetail.do?mcode=${mcode}'>취소하기</a>                                            
