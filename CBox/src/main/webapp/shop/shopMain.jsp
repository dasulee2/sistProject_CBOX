...
<body>
	...
	<div style="margin:auto; width:80%; text-align: center; background:#EAEAEA; border-radius:10px; margin-bottom: 100px; padding-bottom: 50px;">
		<div class="container"style="width: 90%;">
			<br>
			<div >
				<h3  style="text-align: left; padding-left: 10px; color:black; font-size: 30px; font-weight: bold;">스낵바 | <a href="../shop/shopMovie.do" id="movieticket">영화관람권</a></h3>
					<small style=" padding-right: 5px;" ><span style="float: right; padding-bottom: 0px; color:white;"><a class="snackmenu" style="color:#0E100E;" padding-right: 10px; id="beverageList">음료</a></span></small>							
					<small><span style="float: right; padding-bottom: 0px; color:white;"><a class="snackmenu" style="color:#0E100E; padding-right: 10px;" id="snackList">스낵</a></span></small>	
					<small><span style="float: right; padding-bottom: 0px; color:white;"><a class="snackmenu" style="color:#0E100E; padding-right: 10px;" id="popcornList">팝콘</a></span></small>
					<small><span style="float: right; padding-bottom: 0px; color:white;"><a class="snackmenu" style="color:#0E100E; padding-right: 10px;" id="comboList">콤보</a></span></small>
			</div>
			<hr>
