...
<body>
	...
	<div class="container" style="margin:auto; width:80%; text-align: center; background:#EAEAEA; margin-bottom: 100px; border-radius: 10px; padding:50px;">
  		 ...
  		 <form action="MovieDiaryReg.do" method="post">
	  	 	<div class="media" style="background-color: #white; width:80%; margin:auto; border:1px solid silver; border-radius: 10px;">
				...
				<div class="media-body" style="padding:30px;">
					<br>
					<h3 style="font-size: 20px;">&nbsp;&nbsp;&nbsp;&nbsp;${md.getMovieNm()}&nbsp;&nbsp;&nbsp;<br>
					<small style="font-size: 15px;">&nbsp;&nbsp;${md.getMovieNmEn()}</small></h3>
					<br>
					<p>&nbsp;&nbsp;&nbsp;${md.getMdtime()}</p>
					<p>&nbsp;&nbsp;&nbsp;${md.getTheater()}</p>						
		...
		<br><br><br>
				...
				<input type="hidden" name="mdtime" value="${md.getMdtime()}">
				<input type="hidden" name="mcode" value="${md.getMcode()}">
				<input type="hidden" name="theater" value="${md.getTheater()}" >
				<input type="hidden" name="movieNm" value="${md.getMovieNm()}">
				<input type="hidden" name="movieNmEn" value="${md.getMovieNmEn()}">
				<input type="hidden" name="image" value="${md.getImage()}">
				<input type="hidden" name="mid" value="${mid}">
				<input type="hidden" name="mdseq" value="${md.getMdseq()}">
				...
				<div class="diary-register-wrap" style="width: 80%; margin:auto;">
					<div class="sect-diary-register">
						...
						<div class="article-who-together" style="width: 100%;">
							...
							<input style="width:100%;" name="friend"id="txtMovieWith" type="text" maxlength="60"placeholder="" value="${md.getFriend()}"/>
						...
						<div class="article-how-see">
							...
							<textarea  style="width:100%;" name="content" id="content" required="required" rows="5" cols="55" minlength="2" placeholder="">${md.getContent()}</textarea>
						</div>
					</div>
				</div>
			<br><br>
			<span style="margin-right: 130px;" class=" pull-right"><input id="btnSub" type="submit" value="수정" class="btn btn-danger"></input><span><a href="MovieDiary.do?mid=${mid}" class="btn btn-info">취소</a></span></span>
			</form>
		</div>	
  		 <%-- <div class="container">
  	 	<form action="MovieDiaryEdit.do" method="post">
	  	 	<div class="media" style="background-color: #FEFCF0; padding-left: 250px;">
	  	 			<span class=" pull-right"><input id="btnSub" type="submit" value="등록" class="btn btn-danger"></input><span><a href="MovieDiary.do?mid=${mid}" class="btn btn-info">취소</a></span></span>
					...
					<div class="media-body">
						<br>
						<h3>&nbsp;&nbsp;&nbsp;&nbsp;${md.getMovieNm()}&nbsp;&nbsp;&nbsp;<br>
						<small>&nbsp;&nbsp;${md.getMovieNmEn()}</small></h3>
						<br>
						<p>&nbsp;&nbsp;&nbsp;${md.getMdtime()}</p>
						<p>&nbsp;&nbsp;&nbsp;${md.getTheater()}</p>						
				...
				<div class="diary-register-wrap">
					<div class="sect-diary-register">
						...
						<div class="article-who-together">
							<label for="txtMovieWith"><span><i class="glyphicon glyphicon-user"></i></span></label> <input name="friend"
								id="txtMovieWith" type="text" maxlength="60"
								value="${md.getFriend()}"></input>

						</div>

						<div class="article-how-see">

							<label for="textContent"><span><i class="glyphicon glyphicon-comment"></i></span></label>

							<textarea name="content" id="content" required="required"
								rows="5" cols="55" minlength="2" placeholder="영화 어떻게 보셨나요?">${md.getContent()}</textarea>
						</div>
					</div>
				</div>
			</form>
