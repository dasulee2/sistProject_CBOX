...
<body>
	...
	<div class="container" style="margin-left:296px; width: 78%; border-radius:6px; border:1px solid #EEEEEE; background:#EEEEEE; padding:10px;">	
		...
		<br><br>
			...
			<h4><b style="font-weight: bold; margin-bottom: 30px; font-size: 20px;">사용가능한 기프티콘</b></h4>
					<table class="table" >
						<tr class="active">
							<th>&nbsp;&nbsp;&nbsp;&nbsp;</th>
							<th>기프티콘&nbsp;&nbsp;&nbsp;&nbsp;</th>
				...
				<c:forEach var="g" items="${gList}" varStatus="s">
						<tr>
							<td>${s.count}&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td>${g.giftyconCode }&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td>${g.expireDate }&nbsp;&nbsp;&nbsp;&nbsp;</td>
						</tr>
				</c:forEach>
					</table>
			...
			<br>
			<div id="search" style="width: 90%; margin:auto;">
			<h4><b style="font-weight: bold; margin-bottom: 30px; font-size: 20px;">기프티콘 사용내역</b></h4>
					<table class="table" >
						<tr class="active">
							<th>&nbsp;&nbsp;&nbsp;&nbsp;</th>
							<th>기프티콘&nbsp;&nbsp;&nbsp;&nbsp;</th>
				...
				<c:forEach var="ug" items="${ugList}" varStatus="s">
						<tr>
							<td>${s.count}&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td>${ug.giftyconCode }&nbsp;&nbsp;&nbsp;&nbsp;</td>
							<td>${ug.usedDate}&nbsp;&nbsp;&nbsp;&nbsp;</td>
						</tr>
				</c:forEach>
					</table>
